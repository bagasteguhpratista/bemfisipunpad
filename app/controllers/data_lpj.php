<?php
    ...
    class data_lpj extends controller
    {
        private $db;
        public static $table = "data_lpj";
...
//                $passwordhash = md5(serialize($password));
                ...
                if($file_size > 0){
                    $data['file'] = file::save_file('file', $var['v_pdf_path']."/data_lpj/",$alias);
                }
        ...
        function edit($id){
            ...
            if($_to == "002"){
                ...
                $alias  = admin::alias($name);
                  if(isset($file_del)){
                    @unlink($var['v_pdf_path']."/data_lpj/". $data['file']);
                    $data['file'] = "";
                }
                if($file_size > 0){
        ...
        function delete($idd=null){
            ...
            if($_to == "002"){
                ...
                while($row=db::fetch($rs['row'])){
                    @unlink($var['v_pdf_path']."/data_lpj/". $row['file']);
                }
