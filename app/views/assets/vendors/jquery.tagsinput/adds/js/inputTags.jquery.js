(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'Peringatan, Anda tidak dapat menambahkan tag kosong.',
            minLength: 'Peringatan, tag Anda harus memiliki setidaknya %s karakter.',
            maxLength: 'Peringatan, tag Anda tidak boleh melebihi %s karakter.',
            max: 'Peringatan, jumlah tag tidak boleh melebihi %s tags.',
            email: 'Peringatan, alamat email yang Anda masukkan tidak valid',
            exists: 'Peringatan, tag ini sudah ada!',
            autocomplete_only: 'Peringatan, Anda harus memilih nilai dari daftar.',
            timeout: 8000
        }
    };
