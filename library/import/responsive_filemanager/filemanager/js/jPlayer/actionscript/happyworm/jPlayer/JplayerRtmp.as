		...
		private function onResult(result:Object):void
		{
			...
			if (! myStatus.metaDataReady)
			{
				...
				*/
				...
				{
					pause(myStatus.pausePosition);// Always code the pausePosition. Important for setMedia() followed by pause(time). Deals with not reading stream.time with setMedia() and play() immediately followed by stop() or pause(0)
				}
